...
public class SaturationPotion {
    public static Potion registerSaturationPotion(String name) {
        return Registry.register(Registry.POTION, new Identifier(BetterPotions.MOD_ID, name),
                new Potion(new StatusEffectInstance(StatusEffects.SATURATION, 6000, 1)));
    }
}