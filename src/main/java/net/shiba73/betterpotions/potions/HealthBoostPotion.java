...
public class HealthBoostPotion {
    public static Potion registerHealthBoostPotion(String name) {
        return Registry.register(Registry.POTION, new Identifier(BetterPotions.MOD_ID, name),
                new Potion(new StatusEffectInstance(StatusEffects.HEALTH_BOOST, 6000, 1)));
    }
}
